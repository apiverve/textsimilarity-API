...
```gradle
dependencies {
    implementation 'com.github.apiverve:textsimilarity-api:1.1.12'
}
```
...
```java
import com.apiverve.textsimilarity.TextSimilarityAPIClient;
import com.apiverve.textsimilarity.APIResponse;
import com.apiverve.textsimilarity.APIException;

// Initialize the client
TextSimilarityAPIClient client = new TextSimilarityAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/textsimilarity](https://docs.apiverve.com/ref/textsimilarity)
...
- **Documentation:** [https://docs.apiverve.com/ref/textsimilarity](https://docs.apiverve.com/ref/textsimilarity)
- **Issues:** [GitHub Issues](https://github.com/apiverve/textsimilarity-api/issues)
